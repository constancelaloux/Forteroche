...
class Form2 
{
   /**
     ...
     * @return \Illuminate\Support\HtmlString
     */
    public function input($label, $type, $name, $value = null, $options = [])
    {
        $this->type = $type;
     ...
     * @return \Illuminate\Support\HtmlString
     */
    public function text($labelname, $name, $value = null, $options = [])
    {
        //print_r($labelname);
        //, $labelvalue = null, $options = [], $escape_html = true
