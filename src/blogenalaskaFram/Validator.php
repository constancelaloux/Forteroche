 ...
 * Elle sert a gérer les erreurs des utilisateurs
...
class Validator 
{
    ...
    */
    ...
    /**
    * Vérifie que les champs sont presents dans le tableau.
    * @param string[] ...$keys
    * @return Validator
    */
    ...
    */
    ...
    public function dateTime(string $key, string $format = 'Y-m-d H:i:s'):self
    {
        ...
        if($errors['error_count'] > 0 || $errors['varning_count'] > 0 || $date === false)
        {
    ...
    {
        //print_r('je passe dans is valid');
