                    ...
                    (
                        {
                            ...
                            ajax:
                                {
                                    url :"/public/index.php?action=getCommentsIntoDatatables", // json datasource
                                    type:"POST",
                                    dataType: 'json'
                                },
                            "language": 
                        ...
                        if(confirm("Voulez vous supprimer ce commentaire?"))
                            {
                                $.ajax
                                    ({
                                        url:"/public/index.php?action=removeComments",
                                        method:"POST",
                                        data:{id:id},
                                        dataType: 'html',
                                        success:function(data)
                                            {
                                                table.ajax.reload();
                                                var url = '/public/index.php?action=getCommentsViewDatatables';
                        ...
                        if(confirm("Are you sure you want to validate this?"))
                            {
                                $.ajax
                                ({
                                    url:"/public/index.php?action=validateArticles",
                                    method:"POST",
                                    data:{id:id},
                                    dataType: 'html',
                                    success:function(data)
