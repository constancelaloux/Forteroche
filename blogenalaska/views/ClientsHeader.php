...
<!--Le menu de navigation--> 
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/public/index.php?action=goToFrontPageOfTheBlog"  style="color: rgba(0,0,0,.5);">ACCUEIL</a> <!-- style="color: rgba(70, 156, 214, 0.9);">Accueil</a>-->
                    </li>
                        ...
                        <div class="d-flex">
                            <div class="dropdown mr-1">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                        <div>
                                            <a class="dropdown-item" href="/public/index.php?action=disconnectTheClient">Déconnexion</a>
                                            ...
                                            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#getModal">Supprimer mon compte</button>
                                            <a class="dropdown-item" href="/public/index.php?action=updateClientForm&id=<?php echo $_SESSION['ClientId']?>">Réinitialiser mon compte</a>
                                        </div>
                                    </div>
                            </div> 
                        </div>
                ...
                <div class="d-flex">
                    <div class="dropdown mr-1">
                            <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-offset="10,20"  style="background-color: white;">                                             
                                <img src="/public/images/connect.png">
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                <div>
                                    <a class="dropdown-item" href="/public/index.php?action=getTheFormClientsConnexion">Connexion</a>
                                </div>
                            </div>
                    </div> 
                </div>  
    ...
    $('#validateDeleteClient').on('click', function(e)
        {
            ...
            $.ajax(
                {
                    url         : '/public/index.php?action=removeClient',     // point to server-side PHP script 
                    method      :"POST",
                    dataType: 'html',
                    data        : {'data' : form_data},
                    success     : function(response)
                        {
                            var url = "/public/index.php?action=disconnectTheClient"; 
